...
export default function AppCard({
  ...
  return (
    <div
      className="rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 backdrop-blur-sm"
      style={{
    ...
    >
      <div className="p-6">
        <h2 className="text-2xl font-bold mb-3" style={{ color: 'var(--heading-color)' }}>
          {title}
        </h2>
